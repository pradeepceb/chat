...
$(document).ready(function() {
	...
	window.setInterval(function(){
	 $.post('post.php', load_data,  function(data) {
	...
	$("#chat_message").keypress(function(evt) {
		if(evt.which == 13) {
				...
				$.post('post.php', post_data, function(data) {
...
<div class="header">Chat Box <div class="close_btn">&nbsp;</div></div>
  ...
  <div class="message_box">
    ...
    <div class="user_info">
    <input name="chat_username" id="chat_username" type="text" placeholder="Your Name" maxlength="15" />
   <input name="chat_message" id="chat_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
    </div>
    </div>
</div>
</body>
